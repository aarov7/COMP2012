...
void test9(){
    cout << "-------------------------begin of test 9-------------------------" << endl;
    LegoGPT legoGPT;
    FilterModule spanish("Spanish filter", language);
    spanish.trainPreData("como esta", "how are you");
    legoGPT.LoadFilterModule(spanish);
    legoGPT.printFilters();
    legoGPT.printLanguages();
    legoGPT.clear();
    legoGPT.clear();
    legoGPT.clear();
    cout << "-------------------------end of test 9-------------------------" << endl;
}
