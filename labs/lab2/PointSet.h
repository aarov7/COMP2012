...
class PointSet
{
  public:
    ...
    // It also initializes the data member "capacity" and set num_points to 0.
    ...
    PointSet(const Point points[], int num_points); 
  ...
  private:
    ...
    int capacity;
    int numPoints;
    bool isCollinear_3points(Point p1, Point p2, Point p3) const; // return true if 3 given points are on the same straight line
};
